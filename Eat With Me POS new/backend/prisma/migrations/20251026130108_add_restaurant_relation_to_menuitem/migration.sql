/*
  ...
  - You are about to drop the column `dbUrl` on the `Restaurant` table. All the data in the column will be lost.
  - You are about to drop the column `uniqueCode` on the `Restaurant` table. All the data in the column will be lost.
  ...
  - You are about to drop the column `userPassword` on the `Restaurant` table. All the data in the column will be lost.

*/
-- DropIndex
DROP INDEX "Restaurant_uniqueCode_key";
