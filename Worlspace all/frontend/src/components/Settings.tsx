...
export function Settings({ 
  ...
  const updateTempField = (field: string, value: string) => {
    if (tempCompanyInfo) {
      setTempCompanyInfo((prev: typeof tempCompanyInfo) => prev ? { ...prev, [field]: value } : null);
    }
  };
      ...
      <div>
        ...
        {isEditing ? (
          <div className="space-y-2">
            ...
            {type === 'select' && options && (
              <Select value={displayValue as string} onValueChange={(value: string) => updateTempField(field, value)}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  ...
                  <div className="p-4 border border-gray-200 rounded-lg bg-gray-50">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <Input
                        ...
                        onChange={(e) => setNewDepartment((prev: typeof newDepartment) => ({ ...prev, name: e.target.value }))}
                      />
                      <Input
                        placeholder="Description"
                        value={newDepartment.description}
                        onChange={(e) => setNewDepartment((prev: typeof newDepartment) => ({ ...prev, description: e.target.value }))}
                      />
                      <Select value={newDepartment.head} onValueChange={(value: string) => setNewDepartment((prev: typeof newDepartment) => ({ ...prev, head: value }))}>
                        <SelectTrigger>
                      ...
                      {editingDepartment?.id === dept.id ? (
                        <div className="flex gap-2 flex-1">
                          <Input
                            ...
                            onChange={(e) => setEditingDepartment((prev: any) => ({ ...prev, name: e.target.value }))}
                            className="flex-1"
                          />
                          <Input
                            value={editingDepartment.description}
                            onChange={(e) => setEditingDepartment((prev: any) => ({ ...prev, description: e.target.value }))}
                            className="flex-1"
                          />
                  ...
                  <div className="p-4 border border-gray-200 rounded-lg bg-gray-50">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <Input
                        ...
                        onChange={(e) => setNewLocation((prev: typeof newLocation) => ({ ...prev, name: e.target.value }))}
                      />
                      <Input
                        placeholder="Address"
                        value={newLocation.address}
                        onChange={(e) => setNewLocation((prev: typeof newLocation) => ({ ...prev, address: e.target.value }))}
                      />
                      <Select value={newLocation.timezone} onValueChange={(value: string) => setNewLocation((prev: typeof newLocation) => ({ ...prev, timezone: value }))}>
                        <SelectTrigger>
                      ...
                      {editingLocation?.id === loc.id ? (
                        <div className="flex gap-2 flex-1">
                          <Input
                            ...
                            onChange={(e) => setEditingLocation((prev: any) => ({ ...prev, name: e.target.value }))}
                            className="flex-1"
                          />
                          <Input
                            value={editingLocation.address}
                            onChange={(e) => setEditingLocation((prev: any) => ({ ...prev, address: e.target.value }))}
                            className="flex-1"
                          />
                  ...
                  <div className="p-4 border border-gray-200 rounded-lg bg-gray-50">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <Input
                        ...
                        onChange={(e) => setNewJobTitle((prev: typeof newJobTitle) => ({ ...prev, title: e.target.value }))}
                      />
                      <Select value={newJobTitle.department} onValueChange={(value: string) => setNewJobTitle((prev: typeof newJobTitle) => ({ ...prev, department: value }))}>
                        <SelectTrigger>
                      ...
                      <Select value={newJobTitle.level} onValueChange={(value: string) => setNewJobTitle((prev: typeof newJobTitle) => ({ ...prev, level: value }))}>
                        <SelectTrigger>
                      ...
                      {editingJobTitle?.id === job.id ? (
                        <div className="flex gap-2 flex-1">
                          <Input
                            ...
                            onChange={(e) => setEditingJobTitle((prev: any) => ({ ...prev, title: e.target.value }))}
                            className="flex-1"
                          />
                          <Select value={editingJobTitle.department} onValueChange={(value: string) => setEditingJobTitle((prev: any) => ({ ...prev, department: value }))}>
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        <Input
                          ...
                          value={newUser.name}
                          onChange={(e) => setNewUser((prev: typeof newUser) => ({ ...prev, name: e.target.value }))}
                        />
                        <Input
                          placeholder="Email Address"
                          value={newUser.email}
                          onChange={(e) => setNewUser((prev: typeof newUser) => ({ ...prev, email: e.target.value }))}
                        />
                      </div>
                      <div className="grid grid-cols-2 gap-4">
                        <Select value={newUser.role} onValueChange={(value: string) => setNewUser((prev: typeof newUser) => ({ ...prev, role: value }))}>
                          <SelectTrigger>
                        ...
                        <div className="flex items-center space-x-2">
                          <Checkbox
                            ...
                            onCheckedChange={(checked) => setNewUser((prev: typeof newUser) => ({ ...prev, isEmployee: !!checked }))}
                          />
                      ...
                      {newUser.isEmployee && (
                        <div className="grid grid-cols-2 gap-4">
                          <Select value={newUser.department} onValueChange={(value: string) => setNewUser((prev: typeof newUser) => ({ ...prev, department: value }))}>
                            <SelectTrigger>
                              <SelectValue placeholder="Department" />
                            </SelectTrigger>
                            <SelectContent>
                          ...
                          <Select value={newUser.jobTitle} onValueChange={(value: string) => setNewUser((prev: typeof newUser) => ({ ...prev, jobTitle: value }))}>
                            <SelectTrigger>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setLeaveSettings((prev: typeof leaveSettings) => ({ ...prev, annualLeave: parseInt(e.target.value) || 0 }))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setLeaveSettings((prev: typeof leaveSettings) => ({ ...prev, sickLeave: parseInt(e.target.value) || 0 }))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setLeaveSettings((prev: typeof leaveSettings) => ({ ...prev, personalLeave: parseInt(e.target.value) || 0 }))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setLeaveSettings((prev: typeof leaveSettings) => ({ ...prev, maternityLeave: parseInt(e.target.value) || 0 }))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setLeaveSettings((prev: typeof leaveSettings) => ({ ...prev, paternityLeave: parseInt(e.target.value) || 0 }))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setLeaveSettings((prev: typeof leaveSettings) => ({ ...prev, carryForwardLimit: parseInt(e.target.value) || 0 }))}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setLeaveSettings((prev: typeof leaveSettings) => ({ ...prev, approvalRequired: checked }))}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setLeaveSettings((prev: typeof leaveSettings) => ({ ...prev, allowNegativeBalance: checked }))}
                  />
                </div>
              </div>
            </CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setAttendanceSettings((prev: typeof attendanceSettings) => ({ ...prev, workingHoursStart: e.target.value }))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setAttendanceSettings((prev: typeof attendanceSettings) => ({ ...prev, workingHoursEnd: e.target.value }))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setAttendanceSettings((prev: typeof attendanceSettings) => ({ ...prev, coreHoursStart: e.target.value }))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setAttendanceSettings((prev: typeof attendanceSettings) => ({ ...prev, coreHoursEnd: e.target.value }))}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setAttendanceSettings((prev: typeof attendanceSettings) => ({ ...prev, flexibleHours: checked }))}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setAttendanceSettings((prev: typeof attendanceSettings) => ({ ...prev, autoClockOut: checked }))}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setAttendanceSettings((prev: typeof attendanceSettings) => ({ ...prev, trackLocation: checked }))}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setAttendanceSettings((prev: typeof attendanceSettings) => ({ ...prev, enableGeofencing: checked }))}
                  />
                </div>
              </div>
            </CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setSecuritySettings((prev: typeof securitySettings) => ({ ...prev, sessionTimeout: parseInt(e.target.value) || 0 }))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setSecuritySettings((prev: typeof securitySettings) => ({ ...prev, loginAttempts: parseInt(e.target.value) || 0 }))}
                  />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setSecuritySettings((prev: typeof securitySettings) => ({ ...prev, twoFactorAuth: checked }))}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setSecuritySettings((prev: typeof securitySettings) => ({ ...prev, auditLogging: checked }))}
                  />
                </div>
              </div>
            </CardContent>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setNotificationSettings((prev: typeof notificationSettings) => ({ ...prev, emailNotifications: checked }))}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setNotificationSettings((prev: typeof notificationSettings) => ({ ...prev, pushNotifications: checked }))}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setNotificationSettings((prev: typeof notificationSettings) => ({ ...prev, leaveRequests: checked }))}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setNotificationSettings((prev: typeof notificationSettings) => ({ ...prev, taskDeadlines: checked }))}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setNotificationSettings((prev: typeof notificationSettings) => ({ ...prev, attendanceAlerts: checked }))}
                  />
                </div>
                <div className="flex items-center justify-between">
                  <div>
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setNotificationSettings((prev: typeof notificationSettings) => ({ ...prev, announcementAlerts: checked }))}
                  />
                </div>
              </div>
            </CardContent>
